...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Create New Contac</div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('contacts.store') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="tel" class="form-control @error('email') is-invalid @enderror" name="email" 
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="age" type="tel" class="form-control @error('age') is-invalid @enderror" name="age"
